...
#     assert_written_to_cache("views/en/USD/viauco/products/all--#{product.updated_at.utc.to_s(:number)}")
#     assert_written_to_cache("views/en/USD/viauco/products/#{product.id}-#{product.updated_at.utc.to_s(:number)}")
...
#     product2.destroy
#     visit viauco.root_path
#     assert_written_to_cache("views/en/USD/viauco/products/all--#{Date.today.to_s(:number)}-0")
...
#     product.destroy
#     visit viauco.root_path
#     assert_written_to_cache("views/en/USD/viauco/products/all--#{product2.updated_at.utc.to_s(:number)}")
#     expect(cache_writes.count).to eq(1)
#   end
