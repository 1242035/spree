...
describe Viauco::ProductsController, type: :controller do
  ...
  it 'allows admins to view non-active products' do
    allow(controller).to receive_messages viauco_current_user: mock_model(Viauco.user_class, has_viauco_role?: true, last_incomplete_viauco_order: nil, viauco_api_key: 'fake')
  ...
  it "doesn't error when given an invalid referer" do
    current_user = mock_model(Viauco.user_class, has_viauco_role?: true, last_incomplete_viauco_order: nil, generate_viauco_api_key!: nil)
    allow(controller).to receive_messages viauco_current_user: current_user
