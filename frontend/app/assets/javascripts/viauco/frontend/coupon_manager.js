...
CouponManager.prototype.sendRequest = function () {
  return $.ajax({
    async: false,
    method: 'PATCH',
    url: Viauco.routes.api_v2_storefront_cart_apply_coupon_code,
    dataType: 'json',
    headers: {
      'X-Viauco-Order-Token': Viauco.current_order_token
    },
    data: {
    ...
    this.couponStatus.addClass('alert-success').html(Viauco.translations.coupon_code_applied)
