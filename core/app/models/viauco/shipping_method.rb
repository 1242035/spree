module Viauco
  class ShippingMethod < Viauco::Base
    acts_as_paranoid
    ...
    has_many :zones, through: :shipping_method_zones, class_name: 'Viauco::Zone'
    ...
    def self.calculators
      viauco_calculators.send(model_name_without_viauco_namespace).
        select { |c| c.to_s.constantize < Viauco::ShippingCalculator }
    end

    def tax_category
      Viauco::TaxCategory.unscoped { super }
    end
