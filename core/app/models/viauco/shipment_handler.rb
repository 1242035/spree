  ...
  class ShipmentHandler
    class << self
      def factory(shipment)
        ...
        # Given shipment.shipping_method = Viauco::ShippingMethod::DigitalDownload
        # do we have Viauco::ShipmentHandler::DigitalDownload?
        if sm_handler = "Viauco::ShipmentHandler::#{shipment.shipping_method.name.split('::').last}".safe_constantize
    ...
    def perform
      ...
      @shipment.process_order_payments if Viauco::Config[:auto_capture_on_dispatch]
