module Viauco
  class StockItem < Viauco::Base
    ...
    scope :with_active_stock_location, -> { joins(:stock_location).merge(Viauco::StockLocation.active) }

    def backordered_inventory_units
      Viauco::InventoryUnit.backordered_for_stock_item(self)
    end
    ...
    def conditional_variant_touch
      ...
      variant.touch if !Viauco::Config.binary_inventory_cache || stock_changed
    end
  end
end
