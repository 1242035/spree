...
module Viauco
  class Taxon < Viauco::Base
    ...
    belongs_to :taxonomy, class_name: 'Viauco::Taxonomy', inverse_of: :taxons
    has_many :classifications, -> { order(:position) }, dependent: :delete_all, inverse_of: :taxon
    has_many :products, through: :classifications

    has_many :prototype_taxons, class_name: 'Viauco::PrototypeTaxon', dependent: :destroy
    has_many :prototypes, through: :prototype_taxons, class_name: 'Viauco::Prototype'

    has_many :promotion_rule_taxons, class_name: 'Viauco::PromotionRuleTaxon', dependent: :destroy
    has_many :promotion_rules, through: :promotion_rule_taxons, class_name: 'Viauco::PromotionRule'
    ...
    has_one :icon, as: :viewable, dependent: :destroy, class_name: 'Viauco::TaxonImage'
    ...
    def applicable_filters
      ...
      fs << Viauco::Core::ProductFilters.price_filter if Viauco::Core::ProductFilters.respond_to?(:price_filter)
      fs << Viauco::Core::ProductFilters.brand_filter if Viauco::Core::ProductFilters.respond_to?(:brand_filter)
      fs
    end
