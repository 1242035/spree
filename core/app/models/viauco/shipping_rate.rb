module Viauco
  class ShippingRate < Viauco::Base
    belongs_to :shipment, class_name: 'Viauco::Shipment'
    belongs_to :tax_rate, class_name: 'Viauco::TaxRate'
    belongs_to :shipping_method, class_name: 'Viauco::ShippingMethod', inverse_of: :shipping_rates
    ...
    def shipping_method
      Viauco::ShippingMethod.unscoped { super }
    end

    def tax_rate
      Viauco::TaxRate.unscoped { super }
    end
