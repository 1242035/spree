  ...
  module ReimbursementType::ReimbursementHelpers
    ...
    def create_refund(reimbursement, payment, amount, simulate)
      refund = reimbursement.refunds.build(
        payment: payment,
        amount: amount,
        reason: Viauco::RefundReason.return_processing_reason
      )
    ...
    def create_credit(reimbursement, unpaid_amount, simulate)
      category = Viauco::StoreCreditCategory.default_reimbursement_category(category_options(reimbursement))
      creditable = Viauco::StoreCredit.new(store_credit_params(category, reimbursement, unpaid_amount))
    ...
    def store_credit_params(category, reimbursement, unpaid_amount)
      {
        ...
        category: category,
        created_by: Viauco::StoreCredit.default_created_by,
