module Viauco
  class ReimbursementPerformer
    class << self
      ...
      self.reimbursement_type_engine = Viauco::Reimbursement::ReimbursementTypeEngine
      ...
      def execute(reimbursement, simulate)
        ...
        # {Viauco::ReimbursementType::OriginalPayment => [ReturnItem, ...], Viauco::ReimbursementType::Exchange => [ReturnItem, ...]}
