module Viauco
  class Address < Viauco::Base
    ...
    belongs_to :country, class_name: 'Viauco::Country'
    belongs_to :state, class_name: 'Viauco::State', optional: true
    belongs_to :user, class_name: Viauco.user_class.name, optional: true
    ...
    def self.build_default
      new(country: Viauco::Country.default)
    end
    ...
    def self.required_fields
      Viauco::Address.validators.map do |v|
    ...
    def require_phone?
      Viauco::Config[:address_requires_phone]
    end
    ...
    def state_validate
      ...
      return if country.blank? || !Viauco::Config[:address_requires_state]
