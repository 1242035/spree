...
module Viauco
  class Calculator::DefaultTax < Calculator
    ...
    def self.description
      Viauco.t(:default_tax)
    end

    # Default tax calculator still needs to support orders for legacy reasons
    # Orders created before Viauco 2.1 had tax adjustments applied to the order, as a whole.
    # Orders created with Viauco 2.2 and after, have them applied to the line items individually.
