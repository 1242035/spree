...
# Examples:
#
#   # Viauco::Base includes Preferable and defines preferences as a serialized
#   # column.
#   class Settings < Viauco::Base
...
#   s.save!
module Viauco::Preferences::Preferable
  extend ActiveSupport::Concern

  included do
    extend Viauco::Preferences::PreferableClassMethods
  end
