module Viauco
  class Reimbursement < Viauco::Base
    include Viauco::Core::NumberGenerator.new(prefix: 'RI', length: 9)
    ...
    with_options inverse_of: :reimbursement do
      has_many :refunds
      has_many :credits, class_name: 'Viauco::Reimbursement::Credit'
    ...
    # reimbursements.
    # This allows a store to incorporate custom reimbursement methods that Viauco doesn't know about.
    ...
    def display_total
      Viauco::Money.new(total, currency: order.currency)
    end
    ...
    def perform!
      ...
      if unpaid_amount_within_tolerance?
        ...
        raise IncompleteReimbursementError, Viauco.t('validation.unpaid_amount_not_zero', amount: unpaid_amount)
      end
    end
    ...
    def send_reimbursement_email
      Viauco::ReimbursementMailer.reimbursement_email(id).deliver_later
    end
