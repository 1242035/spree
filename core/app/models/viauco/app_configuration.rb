# This is the primary location for defining viauco preferences
#
# The expectation is that this is created once and stored in
# the viauco environment
#
# setters:
# a.color = :blue
# a[:color] = :blue
...
# a.preferred_color
#
require 'viauco/core/search/base'
...
module Viauco
  class AppConfiguration < Preferences::Configuration
    ...
    preference :layout, :string, default: 'viauco/layouts/viauco_application'
    preference :logo, :string, default: 'logo/viauco_50.png'
    ...
    # searcher_class allows viauco extension writers to provide their own Search class
    def searcher_class
      @searcher_class ||= Viauco::Core::Search::Base
    end
