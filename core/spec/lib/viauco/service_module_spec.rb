...
describe Viauco::ServiceModule do
  context 'noncallable thing passed to run' do
    ...
    it 'raises NonCallablePassedToRun' do
      expect { ServiceObjectWithUncallableThing.new.call }.to raise_error(Viauco::ServiceModule::NonCallablePassedToRun)
    end
  end
  ...
  context 'unimplemented method' do
    ...
    it 'raises MethodNotImplemented' do
      expect { ServiceObjectWithMissingMethod.new.call }.to raise_error(Viauco::ServiceModule::MethodNotImplemented)
    end

    it 'returns message in exception' do
      begin
        ServiceObjectWithMissingMethod.new.call
      rescue Viauco::ServiceModule::MethodNotImplemented => e
  ...
  context 'non wrapped value' do
    ...
    it 'raises WrongDataPassed' do
      expect { ServiceObjectWithNonWrappedReturn.new.call }.to raise_error(Viauco::ServiceModule::WrongDataPassed)
    end

    it 'returns message in exception' do
      begin
        ServiceObjectWithNonWrappedReturn.new.call
      rescue Viauco::ServiceModule::WrongDataPassed => e
  ...
  context 'first method failed' do
    ...
    it 'returns result which is instance of Result' do
      result = ServiceObjectWithFailure.new.call
      expect(result).to be_an_instance_of(Viauco::ServiceModule::Result)
    end
    ...
    it 'returns Result instance' do
      expect(ServiceObjectWithFailure.new.call).to be_an_instance_of(Viauco::ServiceModule::Result)
    end
  end
  ...
  context 'not compatible params passed as result' do
    ...
    it 'raises exception' do
      ...
      expect { service.call }.to raise_error(Viauco::ServiceModule::IncompatibleParamsPassed)
    end
  end
end
