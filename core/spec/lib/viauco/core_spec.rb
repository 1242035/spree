...
describe Viauco do
  describe '.admin_path' do
    it { expect(described_class.admin_path).to eq(Viauco::Config[:admin_path]) }
  end
  ...
  describe '.admin_path=' do
    ...
    it { expect(Viauco::Config[:admin_path]).to eq(new_admin_path) }
  end

  describe '.user_class' do
    after do
      described_class.user_class = 'Viauco::LegacyUser'
    end
    ...
    context 'when user_class is a Symbol instance' do
      it 'returns the user_class constant' do
        ...
        expect(described_class.user_class).to eq(Viauco::LegacyUser)
      end
    end
    ...
    context 'when constantize is false' do
      it 'returns the user_class as a String' do
        ...
        expect(described_class.user_class(constantize: false)).to eq('Viauco::LegacyUser')
      end
    end
  end
end
