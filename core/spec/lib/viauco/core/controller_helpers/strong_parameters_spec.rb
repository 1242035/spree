...
describe Viauco::Core::ControllerHelpers::StrongParameters, type: :controller do
  controller(FakesController) {}

  describe '#permitted_attributes' do
    it 'returns Viauco::PermittedAttributes module' do
      expect(controller.permitted_attributes).to eq Viauco::PermittedAttributes
    end
  end
