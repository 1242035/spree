...
module Viauco
  module Core
    describe Importer::Order do
      ...
      let(:product) do
        product = Viauco::Product.create(name: 'Test',
                                        sku: 'TEST-1',
      ...
      context 'assigning a user to an order' do
        ...
        context 'as an admin' do
          before { allow(user).to receive_messages has_viauco_role?: true }
        ...
        context 'as a user' do
          before { allow(user).to receive_messages has_viauco_role?: false }
