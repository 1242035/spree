...
describe Viauco::ReimbursementPerformer, type: :model do
  ...
  let(:reimbursement_type_engine) { Viauco::Reimbursement::ReimbursementTypeEngine }
  ...
  describe '.simulate' do
    it 'reimburses each calculated reimbursement types with the correct return items as a simulation' do
      ...
      Viauco::ReimbursementPerformer.simulate(reimbursement)
    end
  end
  ...
  describe '.perform' do
    it 'reimburses each calculated reimbursement types with the correct return items as a performance' do
      ...
      Viauco::ReimbursementPerformer.perform(reimbursement)
    end
  end
end
