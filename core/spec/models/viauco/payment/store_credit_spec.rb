    ...
    context 'a store credit' do
      ...
      let(:successful_response) do
        ActiveMerchant::Billing::Response.new(
          true,
          Viauco.t('store_credit_payment_method.successful_action', action: :cancel),
          {},
      ...
      let(:failed_response) do
        ActiveMerchant::Billing::Response.new(
          false,
          Viauco.t('store_credit_payment_method.unable_to_find_for_action', action: :cancel,
      ...
      context 'does not cancel successfully' do
        it 'does not change the payment state' do
          ...
          expect { subject }.to raise_error(Viauco::Core::GatewayError)
