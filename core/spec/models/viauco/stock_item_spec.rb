...
describe Viauco::StockItem, type: :model do
  ...
  context 'adjust count_on_hand' do
    ...
    it 'is updated pessimistically' do
      copy = Viauco::StockItem.find(subject.id)
  ...
  context 'with stock movements' do
    before { Viauco::StockMovement.create(stock_item: subject, quantity: 1) }
  ...
  describe '#after_save' do
    ...
    context 'binary_inventory_cache is set to true' do
      before { Viauco::Config.binary_inventory_cache = true }
  ...
  describe 'scopes' do
    context '.with_active_stock_location' do
      let(:stock_items_with_active_location) { Viauco::StockItem.with_active_stock_location }
