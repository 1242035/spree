...
describe Viauco::Adjustable::Adjuster::Tax, type: :model do
  ...
  context 'taxes with promotions' do
    ...
    let!(:promotion) do
      Viauco::Promotion.create(name: '$10 off')
    end

    let!(:promotion_action) do
      calculator = Viauco::Calculator::FlatRate.new(preferred_amount: 10)
      Viauco::Promotion::Actions::CreateItemAdjustments.create(calculator: calculator,
                                                              promotion: promotion)
    end
