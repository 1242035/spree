...
module Viauco
  describe Reimbursement::ReimbursementTypeEngine, type: :model do
    describe '#calculate_reimbursement_types' do
      ...
      let(:reimbursement_type_engine) { Viauco::Reimbursement::ReimbursementTypeEngine.new(return_items) }
      let(:expired_reimbursement_type) { Viauco::ReimbursementType::OriginalPayment }
      let(:override_reimbursement_type) { Viauco::ReimbursementType::OriginalPayment.new }
      let(:preferred_reimbursement_type) { Viauco::ReimbursementType::OriginalPayment.new }
