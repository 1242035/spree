...
describe Viauco::Calculator::FlatPercentItemTotal, type: :model do
  let(:calculator) { Viauco::Calculator::FlatPercentItemTotal.new }
  let(:line_item) { mock_model Viauco::LineItem }
