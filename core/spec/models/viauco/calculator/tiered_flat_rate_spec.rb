...
describe Viauco::Calculator::TieredFlatRate, type: :model do
  let(:calculator) { Viauco::Calculator::TieredFlatRate.new }
  ...
  describe '#compute' do
    ...
    let(:line_item) { mock_model Viauco::LineItem, amount: amount }
