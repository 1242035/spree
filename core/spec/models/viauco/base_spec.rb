...
describe Viauco::Base do
  ...
  it 'does not override Rails 5 default belongs_to_required_by_default' do
    ...
    expect(Viauco::Product.belongs_to_required_by_default).to be(false)
  ...
  it 'does not disable non-viauco, Rails 5 models to validate their associated belongs_to model' do
