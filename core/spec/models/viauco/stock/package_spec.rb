  ...
  module Stock
    describe Package, type: :model do
      ...
      it 'can convert to a shipment' do
        ...
        subject.shipping_rates = [Viauco::ShippingRate.new(shipping_method: shipping_method, cost: 10.00, selected: true)]
      ...
      describe '#order' do
        ...
        context 'there is an inventory unit' do
          ...
          it 'returns an order' do
            expect(subject.order).to be_a_kind_of Viauco::Order
