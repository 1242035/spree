FactoryBot.define do
  factory :promotion, class: Viauco::Promotion do
    name { 'Promo' }
    ...
    trait :with_line_item_adjustment do
      ...
      after(:create) do |promotion, evaluator|
        ...
        Viauco::Promotion::Actions::CreateItemAdjustments.create!(calculator: calculator, promotion: promotion)
      end
    end
    ...
    trait :with_order_adjustment do
      ...
      after(:create) do |promotion, evaluator|
        ...
        action = Viauco::Promotion::Actions::CreateAdjustment.create!(calculator: calculator)
  ...
  factory :free_shipping_promotion, class: Viauco::Promotion do
