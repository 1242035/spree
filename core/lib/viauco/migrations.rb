module Viauco
  class Migrations
    ...
    # First split:
    #
    #   ["20131128203548", "update_name_fields_on_viauco_credit_cards.viauco.rb"]
    #
    # Second split should give the engine_name of the migration
    #
    #   ["update_name_fields_on_viauco_credit_cards", "viauco.rb"]
    #
    ...
    def match_engine?(engine)
      if engine_name == 'viauco'
        # Avoid stores upgrading from 1.3 getting wrong warnings
        ['viauco.rb', 'viauco_promo.rb'].include? engine
      else
