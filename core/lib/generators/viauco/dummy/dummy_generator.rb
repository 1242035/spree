...
module Viauco
  class DummyGenerator < Rails::Generators::Base
    desc 'Creates blank Rails application, installs Viauco and all sample data'
    ...
    def test_dummy_inject_extension_requirements
      if DummyGeneratorHelper.inject_extension_requirements
        inside dummy_path do
          inject_require_for('viauco_frontend')
          inject_require_for('viauco_backend')
          inject_require_for('viauco_api')
        end
      end
    end
...
begin
  ...
  # #{requirement} is not available.
    ...
    def gemfile_path
      core_gems = ['viauco/core', 'viauco/api', 'viauco/backend', 'viauco/frontend']
...
module Viauco::DummyGeneratorHelper
