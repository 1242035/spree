module Viauco
  module Api
    module V2
      module Storefront
        class ProductsController < ::Viauco::Api::V2::BaseController
          ...
          def collection_sorter
            Viauco::Api::Dependencies.storefront_products_sorter.constantize
          end

          def collection_finder
            Viauco::Api::Dependencies.storefront_products_finder.constantize
          end

          def collection_serializer
            Viauco::Api::Dependencies.storefront_product_serializer.constantize
          end
          ...
          def scope
            Viauco::Product.accessible_by(current_ability, :show).includes(scope_includes)
          end
