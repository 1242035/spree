module Viauco
  module Api
    module V2
      module Storefront
        class CountriesController < ::Viauco::Api::V2::BaseController
          ...
          def resource_serializer
            Viauco::Api::Dependencies.storefront_country_serializer.constantize
          end
          ...
          def collection_finder
            Viauco::Api::Dependencies.storefront_country_finder.constantize
          end

          def scope
            Viauco::Country.accessible_by(current_ability, :show)
          end
        end
      end
    end
