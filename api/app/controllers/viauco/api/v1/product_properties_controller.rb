module Viauco
  module Api
    module V1
      class ProductPropertiesController < Viauco::Api::BaseController
        ...
        def product_property
          if @product
            ...
            @product_property ||= @product.product_properties.includes(:property).where(viauco_properties: { name: params[:id] }).first
