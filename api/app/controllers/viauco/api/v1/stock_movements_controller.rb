module Viauco
  module Api
    module V1
      class StockMovementsController < Viauco::Api::BaseController
        ...
        def stock_location
          render 'viauco/api/v1/shared/stock_location_required', status: 422 and return unless params[:stock_location_id]
