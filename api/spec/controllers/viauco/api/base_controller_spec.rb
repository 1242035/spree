...
class FakesController < Viauco::Api::BaseController
end

describe Viauco::Api::BaseController, type: :controller do
  render_views
  controller(Viauco::Api::BaseController) do
    def index
  ...
  before do
    @routes = ActionDispatch::Routing::RouteSet.new.tap do |r|
      r.draw { get 'index', to: 'viauco/api/base#index' }
    end
  end
  ...
  context 'cannot make a request to the API' do
    ...
    it 'with an invalid API key' do
      request.headers['X-Viauco-Token'] = 'fake_key'
      get :index
