...
module Viauco
  describe Api::V1::ProductPropertiesController, type: :controller do
    ...
    it 'can query the results through a parameter' do
      Viauco::ProductProperty.last.update_attribute(:value, 'loose')
      property = Viauco::ProductProperty.last
    ...
    context 'as an admin' do
      ...
      context 'when product property exists' do
        ...
        context 'when product property is invalid' do
          before do
            expect_any_instance_of(Viauco::ProductProperty).to receive(:update).and_return false
          end
