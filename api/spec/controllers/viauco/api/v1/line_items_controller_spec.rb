...
module Viauco
  ...
  Viauco::Api::V1::LineItemsController.line_item_options += [:some_option]
  ...
  describe Api::V1::LineItemsController, type: :controller do
    ...
    context 'as the order owner' do
      ...
      context 'order contents changed after shipments were created' do
        ...
        let!(:line_item) { Viauco::Cart::AddItem.call(order: order, variant: product.master).value }
        ...
        context 'order is completed' do
          before do
            current_api_user.viauco_roles << admin_role
            order.reload
