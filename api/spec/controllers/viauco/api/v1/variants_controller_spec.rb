...
module Viauco
  describe Api::V1::VariantsController, type: :controller do
    ...
    it 'adds for_currency_and_available_price_amount scope to variants list' do
      expect(Viauco::Variant).to receive(:for_currency_and_available_price_amount).
        and_return(Viauco::Variant.for_currency_and_available_price_amount)
      api_get :index
    end
    ...
    context 'as an admin' do
      ...
      it 'can delete a variant' do
        ...
        expect { Viauco::Variant.find(variant.id) }.to raise_error(ActiveRecord::RecordNotFound)
      end
