...
module Viauco
  describe Api::V1::StoresController, type: :controller do
    ...
    let!(:store) do
      create(:store, name: 'My Viauco Store', url: 'viaucostore.example.com')
    end
    ...
    context 'as an admin' do
      ...
      it 'I can list the available stores' do
        ...
        expect(json_response['stores']).to eq(
          [
            {
              'id' => store.id,
              'name' => 'My Viauco Store',
              'url' => 'viaucostore.example.com',
      ...
      it 'I can update an existing store' do
        ...
        expect(store.reload.url).to eql 'viauco123.example.com'
