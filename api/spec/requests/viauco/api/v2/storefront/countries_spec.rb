...
describe 'Storefront API v2 Countries spec', type: :request do
  ...
  let!(:default_country) do
    ...
    Viauco::Config[:default_country_id] = country.id
    country
  end
  ...
  describe 'countries#index' do
    context 'general' do
      ...
      it 'returns all countries' do
        expect(json_response['data'].size).to eq(Viauco::Country.count)
  ...
  describe 'country#show' do
    context 'by iso' do
      ...
      it 'returns country by iso' do
        ...
        expect(json_response['data']).to have_attribute(:default).with_value(country == Viauco::Country.default)
