...
module Viauco
  module Admin
    describe Resource, type: :model do
      let(:resource_base) { Resource.new('viauco/admin/test', 'test', 'widget') }
      let(:resource_submodule) { Resource.new('viauco/admin/submodule/test', 'test', 'widget') }
      let(:resource_object_name) { Resource.new('viauco/admin/test', 'test', 'gadget', 'widget') }

      it 'can get base model class' do
        expect(resource_base.model_class).to eq(Viauco::Test)
      end

      it 'can get submodule class' do
        expect(resource_submodule.model_class).to eq(Viauco::Submodule::Test)
      end
