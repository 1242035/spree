      ...
      describe '#create' do
        ...
        context 'valid customer return' do
          ...
          it 'creates a customer return' do
            expect { subject }.to change { Viauco::CustomerReturn.count }.by(1)
          end

          it 'redirects to the index page' do
            subject
            expect(response).to redirect_to(viauco.edit_admin_order_customer_return_path(order, assigns(:customer_return)))
          end
        end
        ...
        context 'invalid customer return' do
          ...
          it "doesn't create a customer return" do
            expect { subject }.not_to change { Viauco::CustomerReturn.count }
          end
