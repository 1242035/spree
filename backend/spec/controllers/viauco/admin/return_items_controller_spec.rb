...
describe Viauco::Admin::ReturnItemsController, type: :controller do
  stub_authorization!
  ...
  describe '#update' do
    ...
    it 'redirects to the custome return' do
      subject
      expect(response).to redirect_to viauco.edit_admin_order_customer_return_path(customer_return.order, customer_return)
    end
  end
end
