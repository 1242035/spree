...
describe Viauco::Admin::ReimbursementsController, type: :controller do
  stub_authorization!

  before do
    Viauco::RefundReason.find_or_create_by!(name: Viauco::RefundReason::RETURN_PROCESSING_REASON, mutable: false)
  end
  ...
  describe '#create' do
    ...
    it 'redirects to the edit page' do
      subject
      expect(response).to redirect_to(viauco.edit_admin_order_reimbursement_path(order, assigns(:reimbursement)))
    end
  end
  ...
  describe '#perform' do
    ...
    it 'redirects to customer return page' do
      subject
      expect(response).to redirect_to viauco.admin_order_reimbursement_path(order, reimbursement)
    end
    ...
    context 'a Viauco::Core::GatewayError is raised' do
      ...
      it 'redirects to the edit page' do
        subject
        redirect_path = viauco.edit_admin_order_reimbursement_path(order, assigns(:reimbursement))
