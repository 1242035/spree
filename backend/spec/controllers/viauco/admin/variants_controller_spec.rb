    ...
    describe VariantsController, type: :controller do
      ...
      describe '#destroy' do
        ...
        before do
          ...
          allow(Viauco::Variant).to receive(:find).with(variant.id.to_s).and_return(variant)
        end
        ...
        describe 'expects to receive' do
          ...
          it { expect(Viauco::Variant).to receive(:find).with(variant.id.to_s).and_return(variant) }
        end
        ...
        context 'will successfully destroy variant' do
          ...
          describe 'returns response' do
            ...
            it { expect(flash[:success]).to eq(Viauco.t('notice_messages.variant_deleted')) }
          end
        end
        ...
        context 'will not successfully destroy product' do
          ...
          describe 'returns response' do
            ...
            it { expect(flash[:error]).to eq(Viauco.t('notice_messages.variant_not_deleted', error: error_msg)) }
          end
        end
      end
    end
