    ...
    class StockTransfersController < Admin::BaseController
      ...
      def create
        if params[:variant].nil?
          flash[:error] = Viauco.t('stock_transfer.errors.must_have_variant')
          render :new
        else
          variants = Hash.new(0)
          ...
          flash[:success] = Viauco.t(:stock_successfully_transferred)
      ...
      def load_stock_locations
        @stock_locations = Viauco::StockLocation.active.order_default
      end
