module Viauco
  module Admin
    class ReturnAuthorizationsController < ResourceController
      belongs_to 'viauco/order', find_by: :number
      ...
      def fire
        ...
        flash[:success] = Viauco.t(:return_authorization_updated)
        redirect_back fallback_location: viauco.edit_admin_order_return_authorization_path(@order, @return_authorization)
      end
      ...
      def load_return_items
        ...
        new_return_items = unassociated_inventory_units.map do |new_unit|
          Viauco::ReturnItem.new(inventory_unit: new_unit, return_authorization: @return_authorization).tap(&:set_default_pre_tax_amount)
        end
      ...
      def load_return_authorization_reasons
        @reasons = Viauco::ReturnAuthorizationReason.active.to_a
