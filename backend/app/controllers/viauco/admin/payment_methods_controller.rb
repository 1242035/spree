    ...
    class PaymentMethodsController < ResourceController
      ...
      def create
        ...
        if @payment_method.save
          ...
          flash[:success] = Viauco.t(:successfully_created, resource: Viauco.t(:payment_method))
      ...
      def update
        ...
        if @payment_method.update(attributes)
          ...
          flash[:success] = Viauco.t(:successfully_updated, resource: Viauco.t(:payment_method))
          redirect_to edit_admin_payment_method_path(@payment_method)
        else
      ...
      def validate_payment_method_provider
        valid_payment_methods = Rails.application.config.viauco.payment_methods.map(&:to_s)
        unless valid_payment_methods.include?(params[:payment_method][:type])
          flash[:error] = Viauco.t(:invalid_payment_provider)
