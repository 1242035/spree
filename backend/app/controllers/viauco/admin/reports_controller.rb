module Viauco
  module Admin
    class ReportsController < Viauco::Admin::BaseController
      respond_to :html
      ...
      class << self
        ...
        def add_available_report!(report_key, report_description_key = nil)
          ...
          @@available_reports[report_key] = { name: Viauco.t(report_key), description: Viauco.t(report_description_key) }
        end
      end
      ...
      def model_class
        Viauco::Admin::ReportsController
      end
