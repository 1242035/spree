  ...
  module Admin
    class VariantsController < ResourceController
      ...
      def destroy
        ...
        if @variant.destroy
          flash[:success] = Viauco.t('notice_messages.variant_deleted')
        else
          flash[:error] = Viauco.t('notice_messages.variant_not_deleted', error: @variant.errors.full_messages.to_sentence)
        end
