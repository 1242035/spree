...
under the viauco namespace that do stuff we find helpful.
...
jQuery(function ($) {
  ...
  sidebar_toggle.on('click', function() {
    ...
    // these should match `viauco/backend/app/helpers/viauco/admin/navigation_helper.rb#main_part_classes`
    main
...
function handle_date_picker_fields () {
  $('.datepicker').datepicker({
    dateFormat: Viauco.translations.date_picker,
    dayNames: Viauco.translations.abbr_day_names,
    dayNamesMin: Viauco.translations.abbr_day_names,
    firstDay: Viauco.translations.first_day,
    monthNames: Viauco.translations.month_names,
    prevText: Viauco.translations.previous,
    nextText: Viauco.translations.next,
    showOn: 'focus',
    showAnim: ''
  })
...
$(document).ready(function(){
  ...
  var uniqueId = 1
  $('.viauco_add_fields').click(function () {
  ...
  $('body').on('click', 'a.viauco_remove_fields', function () {
    el = $(this)
  ...
  window.Viauco.advanceOrder = function() {
    $.ajax({
      type: 'PUT',
      async: false,
      data: {
      ...
      url: Viauco.url(Viauco.routes.checkouts_api + '/' + order_number + '/advance')
    }).done(function() {
