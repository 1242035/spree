$(function () {
  ...
  function TransferLocations () {
    ...
    $.getJSON(Viauco.url(Viauco.routes.stock_locations_api) + '?token=' + Viauco.api_key + '&per_page=1000', function (data) {
  ...
  TransferVariants.prototype._search_transfer_variants = function () {
    return this.build_select(Viauco.url(Viauco.routes.variants_api), 'product_name_or_sku_cont')
  }

  TransferVariants.prototype._search_transfer_stock_items = function () {
    var stockLocationId = $('#transfer_source_location_id').val()
    return this.build_select(Viauco.url(Viauco.routes.stock_locations_api + ('/' + stockLocationId + '/stock_items')), 'variant_product_name_or_variant_sku_cont')
  }
