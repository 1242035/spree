module ViaucoCmd
  class Extension < Thor::Group
    ...
    desc 'builds a viauco extension'
    ...
    def final_banner
      say %{
        ...
        Your extension has been generated with a gemspec dependency on Viauco #{viauco_version}.
    ...
    no_tasks do
      ...
      def viauco_version
        Gem.loaded_specs['viauco_cmd'].version.to_s
      end
