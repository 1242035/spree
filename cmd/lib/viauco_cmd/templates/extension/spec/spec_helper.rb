...
# Requires factories and other useful helpers defined in viauco_core.
...
RSpec.configure do |config|
  ...
  # == URL Helpers
  #
  # Allows access to Viauco's routes in specs:
  #
  # visit viauco.admin_path
  # current_path.should eql(viauco.products_path)
